...
class JustificarPapelHidrossensivelWidget extends StatefulWidget {
  const JustificarPapelHidrossensivelWidget({super.key});

  @override
  State<JustificarPapelHidrossensivelWidget> createState() =>
      _JustificarPapelHidrossensivelWidgetState();
}

class _JustificarPapelHidrossensivelWidgetState
    extends State<JustificarPapelHidrossensivelWidget> {
  ...
  List<String> justificativaOptionStrings = [
    "",
    "Análise não executada/ solicitada",
    "Falta de material",
    "Outros"
  ];
  ...
  _radioItem(int radioValue, String radioText) {
    return Row(
      children: [
        ...
        Flexible(child: Text(radioText, style: TextStyle(fontSize: 16))),
      ],
    );
  }
